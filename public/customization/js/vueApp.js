var app = new Vue({ 
    ...
    mounted(){
        ...
        methods:
        {
            ...
            getlinearts(){
                axios.get('/getlinearts')
                   .then(function (response) {
                       console.log(response.data.jacketstyles)
                        // location.href = 'https://northsmen.com//add-cart-custom/';
                   })
            ...
            getcustomizedata(){
                 axios.get('/getcustomizationdata')
                   .then(function (response) {
    ...
    savecustomization(){
        axios.post('/customizationsettings', {
                style: this.stylePicked,
                lapel: this.lapelPicked,
                fitting: this.fittingPicked,
                bpocket: this.bpocketPicked,
                pocket: this.pocketPicked,
                bsbutton: this.bsbuttonPicked,
                vent: this.ventPicked
