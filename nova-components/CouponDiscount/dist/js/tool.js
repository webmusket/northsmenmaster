...
Nova.booting(function (Vue, router, store) {
  ...
  Vue.component('coupon-discount', __webpack_require__(4));
});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("105c5eac", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios.get('/nova-vendor/coupon-discount/loaddata/' + this.resourceId).then(function (response) {

      _this.individual = response.data.individual, _this.couponemail = response.data.couponemail, _this.amount = response.data.amount, _this.amount_type = response.data.amount_type, _this.minimumspent = response.data.minimumspent, _this.max_uses_user = response.data.max_uses_user, _this.max_uses = response.data.max_uses, _this.excludecouponproducts = response.data.excludecouponproducts, _this.excludecouponcategories = response.data.excludecouponcategories, _this.couponcategories = response.data.couponcategories, _this.couponproducts = response.data.couponproducts, _this.couponemails = response.data.couponemails, _this.products = response.data.products, _this.categories = response.data.categories;
    });
    axios.get('/nova-vendor/coupon-discount/readymade-products').then(function (response) {
      _this.products = response.data;
    });
    axios.get('/nova-vendor/coupon-discount/emails').then(function (response) {
      _this.emails = response.data;
    });
    axios.get('/nova-vendor/coupon-discount/categories').then(function (response) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "main" }, [
    _c(
      ...
      [_c("b", [_vm._v(_vm._s(_vm.resourceName.toUpperCase()) + " DATA")])]
    ),
    _vm._v(" "),
    _c("div", { staticClass: "mainarea" }, [
      _c("div", { staticClass: "tab" }, [
        _c(
          "button",
          {
            staticClass: "tablinks active",
            attrs: { id: "defaultOpen" },
            on: {
              click: function($event) {
                return _vm.openCity(_vm.event, "London")
              }
            }
          },
          [_vm._v("General")]
        ...
        _c(
          "button",
          {
            ...
            on: {
              click: function($event) {
                return _vm.openCity(_vm.event, "Paris")
              }
            }
          },
          [_vm._v("User Restriction")]
        ),
        _vm._v(" "),
        _c(
          "button",
          {
            ...
            on: {
              click: function($event) {
                return _vm.openCity(_vm.event, "Tokyo")
              }
            }
          },
          [_vm._v("Usage limits")]
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "tabcontent", attrs: { id: "London" } }, [
            _c("div", { staticClass: "row" }, [
              ...
              _c("div", { staticClass: "col-75" }, [
                _c("input", {
                  ...
                  attrs: { type: "number", id: "lname", placeholder: "0" },
            ...
            _c("div", { staticClass: "row" }, [
              ...
              _c("div", { staticClass: "col-75" }, [
                _c(
                  "select",
                  {
                    ...
                    on: {
                      change: function($event) {
                        ...
                        _vm.amount_type = $event.target.multiple
                          ? $$selectedVal
                          : $$selectedVal[0]
                      }
                    }
                  ...
                  [
                    _c("option", { attrs: { value: "Percentage Discount" } }, [
                      _vm._v("Percentage Discount")
                    ]),
                    _vm._v(" "),
                    _c("option", { attrs: { value: "Fixed Cart Discount" } }, [
                      _vm._v("Fixed Cart Discount")
                    ]),
                    _vm._v(" "),
                    _c(
                      "option",
                      { attrs: { value: "Fixed Product Discount" } },
                      [_vm._v("Fixed Product Discount")]
                    )
                  ]
                )
              ])
          ...
          _vm._v(" "),
          _c("div", { staticClass: "tabcontent", attrs: { id: "Paris" } }, [
            _c("div", { staticClass: "row" }, [
              _vm._m(2),
              _vm._v(" "),
              _c(
                ...
                [
                  _c("multiselect", {
                    ...
                    model: {
                      value: _vm.couponproducts,
                      callback: function($$v) {
                        _vm.couponproducts = $$v
                      },
                      expression: "couponproducts"
                    }
                  })
                ],
                1
            ...
            _c("div", { staticClass: "row" }, [
              ...
              _c(
                ...
                [
                  _c("multiselect", {
                    attrs: {
                      id: "excludecouponproducts",
                      multiple: true,
                      options: _vm.products
                    },
                    model: {
                      value: _vm.excludecouponproducts,
                      callback: function($$v) {
                        _vm.excludecouponproducts = $$v
                      },
                      expression: "excludecouponproducts"
                    }
                  })
                ],
                1
              ...
              _c(
                ...
                [
                  _c("multiselect", {
                    ...
                    model: {
                      value: _vm.couponcategories,
                      callback: function($$v) {
                        _vm.couponcategories = $$v
                      },
                      expression: "couponcategories"
                    }
                  })
                ],
                1
            ...
            _c("div", { staticClass: "row" }, [
              ...
              _c(
                ...
                [
                  _c("multiselect", {
                    attrs: {
                      id: "excludecouponcategories",
                      multiple: true,
                      options: _vm.categories
                    },
                    model: {
                      value: _vm.excludecouponcategories,
                      callback: function($$v) {
                        _vm.excludecouponcategories = $$v
                      },
                      expression: "excludecouponcategories"
                    }
                  })
                ],
                1
              ...
              _c(
                ...
                [
                  _c("multiselect", {
                    ...
                    model: {
                      value: _vm.couponemails,
                      callback: function($$v) {
                        _vm.couponemails = $$v
                      },
                      expression: "couponemails"
                    }
                  })
                ],
                1
          ...
          _vm._v(" "),
          _c("div", { staticClass: "tabcontent", attrs: { id: "Tokyo" } }, [
            _c("div", { staticClass: "row" }, [
              _vm._m(7),
              _vm._v(" "),
              _c(
                ...
                {
                  staticClass: "col-75",
                  staticStyle: { "margin-top": "17px", width: "3%" }
                },
                [
                  _c("input", {
                    directives: [
                    ...
                    attrs: { type: "checkbox", id: "individual" },
                    domProps: {
                      checked: Array.isArray(_vm.individual)
                        ? _vm._i(_vm.individual, null) > -1
                        : _vm.individual
                    },
                    on: {
                      change: function($event) {
                        var $$a = _vm.individual,
                          $$el = $event.target,
            ...
            _c("div", { staticClass: "row" }, [
              ...
              _c("div", { staticClass: "col-75" }, [
                _c("input", {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.couponemail,
                      expression: "couponemail"
                    }
                  ],
                  attrs: {
                    type: "text",
                  ...
                  domProps: { value: _vm.couponemail },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.couponemail = $event.target.value
                    }
                  }
                })
              ])
            ...
            _c("div", { staticClass: "row" }, [
              ...
              _c("div", { staticClass: "col-75" }, [
                _c("input", {
                  ...
                  domProps: { value: _vm.max_uses },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.max_uses = $event.target.value
                    }
                  }
                })
              ])
            ...
            _c("div", { staticClass: "row" }, [
              ...
              _c("div", { staticClass: "col-75" }, [
                _c("input", {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.max_uses_user,
                      expression: "max_uses_user"
                    }
                  ],
                  attrs: {
                    type: "number",
                  ...
                  domProps: { value: _vm.max_uses_user },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.max_uses_user = $event.target.value
                    }
                  }
                })
              ])
            ...
            _c("div", { staticClass: "row" }, [
              ...
              _c("div", { staticClass: "col-75" }, [
                _c("input", {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.minimumspent,
                      expression: "minimumspent"
                    }
                  ],
                  attrs: {
                    type: "number",
                  ...
                  domProps: { value: _vm.minimumspent },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.minimumspent = $event.target.value
                    }
                  }
                })
              ])
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "col-25" }, [
      _c("label", { attrs: { for: "lname" } }, [_vm._v("Discount Amount")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-25" }, [
      _c("label", { attrs: { for: "country" } }, [_vm._v("Discount Type")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-25" }, [
      _c("label", { attrs: { for: "couponproducts" } }, [_vm._v("Products")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-25" }, [
      _c("label", { attrs: { for: "excludecouponproducts" } }, [
        _vm._v("Exclude Products")
      ])
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-25" }, [
      _c("label", { attrs: { for: "couponcategories" } }, [
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-25" }, [
      _c("label", { attrs: { for: "excludecouponcategories" } }, [
        _vm._v("Exclude Product categories")
      ])
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-25" }, [
      _c("label", { attrs: { for: "couponemails" } }, [
        _vm._v("Allowed emails")
      ])
    ])
  },
  function() {
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-25" }, [
      _c("label", { attrs: { for: "max_usages" } }, [
        _vm._v("Usage limit per coupon")
      ])
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-25" }, [
      _c("label", { attrs: { for: "max_user_usages" } }, [
        _vm._v("Usage limit per user")
      ])
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-25" }, [
      _c("label", { attrs: { for: "minimumspent" } }, [_vm._v("Minimum Spent")])
    ])
  },
  function() {
    var _vm = this
