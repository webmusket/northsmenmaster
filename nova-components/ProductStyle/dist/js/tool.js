...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__FileManager_vue__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__FileManager_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__FileManager_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        ...
        FileManager: __WEBPACK_IMPORTED_MODULE_2__FileManager_vue___default.a
    },
    data: function data() {
        return {
            isOpen: false,
...
// module
exports.push([module.i, "\n.file-mana[data-v-6a1d18f6]{\n  margin-top: 20px;\n}\n.align-right[data-v-6a1d18f6]{\n  text-align: right;\n}\n.hovereffect[data-v-6a1d18f6]:hover{\n  background: #fb6969;\n}\n\n\n", ""]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue2_dropzone__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue2_dropzone_dist_vue2Dropzone_min_css__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DeleteModal_vue__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DeleteModal_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__DeleteModal_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: [],
  components: {
    DeleteModal: __WEBPACK_IMPORTED_MODULE_2__DeleteModal_vue___default.a,
  ...
  methods: {
    ...
    //dropzone
    changefabric: function changefabric() {
      var url = "/nova-vendor/product-style/formSubmit/" + this.fabricname;
      this.dropzoneOptions.url = url;
    },
    someSuccessMethod: function someSuccessMethod() {
      this.fabricname = 0;
      this.showfolders = true;
      this.getFolders();
    },
    SuccessMethod: function SuccessMethod() {
      console.log('success');
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("3035e3c2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        deleteFolder: function deleteFolder() {
            ...
            Nova.request().get("/nova-vendor/product-style/delete-folder/" + this.folder).then(function (response) {
                _this.$emit('closedel');
                _this.$parent.getFolders();
            }).catch(function () {
                return _this.error = true;
            });
        }
            ...
            _c(
              ...
              [
                _c("div", { staticClass: "w-full flex flex-wrap" }, [
                  _c("p", { staticClass: "text-center px-6 py-8" }, [
                    _vm._v("Are You Sure to delete " + _vm._s(_vm.folder) + "?")
                  ])
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "bg-30 px-6 py-3 flex" }, [
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "w-full flex flex-wrap" }, [
          ...
          _c(
            ...
            [
              ...
              _vm._l(_vm.fabrics, function(fabric) {
                return _c("option", { domProps: { value: fabric.slug } }, [
                  _vm._v(
                    "\n                    " +
                      _vm._s(fabric.title) +
                      "\n                  "
        ...
        _vm._v(" "),
        _c("div", { staticClass: "w-1/4 py-2 text-right" }, [
          _c(
            "a",
            {
              staticClass:
      ...
      _vm.fabricname != 0
        ? _c(
            "div",
            { staticClass: "w-full flex flex-wrap file-mana" },
            [
              _c("p", { staticClass: "px-6 py-2" }, [
                _vm._v(
                  "Info: Upload Zip file for Fabric for " +
                    _vm._s(this.fabricname)
                )
              ]),
              _vm._v(" "),
              _c("vue-dropzone", {
                ...
                on: {
                  "vdropzone-success": _vm.SuccessMethod,
                  "vdropzone-queue-complete": _vm.someSuccessMethod
                }
              })
            ],
            1
            ...
            _vm._l(_vm.folders, function(folder) {
              return _c("div", { staticClass: "w-1/6 h-40  px-2 mb-3 " }, [
                _c(
                  ...
                  {
                    staticClass:
                      "card relative flex flex-wrap justify-center border border-lg border-50 overflow-hidden px-0 py-0 cursor-pointer h-40 folder-item hovereffect",
