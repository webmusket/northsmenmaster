                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.homesettings.customize_head,
                      expression: "homesettings.customize_head"
                    }
                  ],
                  staticClass:
                    "w-full form-control form-input form-input-bordered",
                  attrs: { placeholder: "Customize Heading", type: "text" },
                  domProps: { value: _vm.homesettings.customize_head },
                  on: {
