                            ...
                            <div class="carousel-item active">
                                <div class="mesurementwcbox">
                                    ...
                                    <section class="mesure-info" id="standardM">
                                        ...
                                        <select id="heightinstandard" name="" class= "fValue" id="fValue1">
                                        ...
                                        <input id="stdweight" type="number" id="wValue1" class="wValue">
                                ...
                                <div class="mesurementwcbox">
                                    ...
                                    <div class="mesure-imfbox">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <label>
                                                    <input type="radio" name="backposture" value="Straight">
                                                    <div class="mimg">
                                            ...
                                            <div class="col-lg-4">
                                                <label>
                                                    <input type="radio" name="backposture" value="Normal" checked>
                                                    <div class="mimg">
                                            ...
                                            <div class="col-lg-4">
                                                <label>
                                                    <input type="radio" name="backposture" value="Forward Leaning">
                                                    <div class="mimg">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <label>
                                                    <input type="radio" name="shoulder" value="Even">                      
                                                    <div class="mimg">
                                            ...
                                            <div class="col-lg-4">
                                                 <label>
                                                    <input type="radio" name="shoulder" value="Average" checked>                   
                                                    <div class="mimg">
                                            ...
                                            <div class="col-lg-4">
                                                <label>
                                                    <input type="radio" name="shoulder" value="Sloping">  
                                                    <div class="mimg">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                 <label>
                                                    <input type="radio" name="ashoulder" value="Lower Left">                        
                                                    <div class="mimg">
                                            ...
                                            <div class="col-lg-4">
                                                <label>
                                                    <input type="radio" name="ashoulder" value="Even" checked>    
                                                    <div class="mimg">
                                            ...
                                            <div class="col-lg-4">
                                                <label>
                                                    <input type="radio" name="ashoulder" value="Lower Right">    
                                                    <div class="mimg">
                                ...
                                <div class="mesurementfitbox">
                                    ...
                                    <div class="fit-mcontentbox">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <label>
                                                    <input type="radio" name="fit" value="Slim Fit"> 
                                                    <div class="fit-mimg">
                                            ...
                                            <div class="col-lg-4">
                                                <label>
                                                    <input type="radio" name="fit" value="Tailored Fit" checked> 
                                                    <div class="fit-mimg">
                                            ...
                                            <div class="col-lg-4">
                                                <label>
                                                    <input type="radio" name="fit" value="Standard Fit"> 
                                                    <div class="fit-mimg">
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty2" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty3" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty4" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty5" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty6" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty7" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty8" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty9" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty10" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty11" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty12" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty13" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="mvideodiv">
                                        ...
                                        <div class="mvideoinfo">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="qty14" class="form-control form-control-sm qty_input" value="1" min="1">
                                                <span class="input-group-append">
                                                    <button class="btn btn-dark btn-sm plus-btn" id="plus-btn"><i class="fa fa-plus"></i></button>
                                                </span>
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 measurebox">
                                                <p>Height and Weight Measurements</p>
                                                <br><br><br>
                                                <div>
                                                    <p>Height</p>
                                                    <span>
                                            ...
                                            <div class="col-lg-4 measurebox">
                                                <p>Fit and Body Shape Measurements</p>
                                                <br><br><br>

                                                <p>Backposture</p>
                                                <span id="backposture">12221</span>
                                                <br>
                                                <p>Shoulder</p>
                                                <span id="shoulder"></span>  
                                                <br>                                              
                                                <p>Fit</p>
                                                <span id="bodyfit"></span>
