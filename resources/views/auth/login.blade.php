...
@if(Session::has('flash_message_error'))
    <div style="border: 1px solid red; padding: 10px; " class="alert alert-error alert-block">
        <button style="color: red" type="button" class="close" data-dismiss="alert">×</button> 
